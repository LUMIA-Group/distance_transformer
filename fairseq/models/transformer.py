...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def forward(
        ...
        src_distance: Optional[list]=None,
...
@register_model_architecture("transformer", "transformer_nc11_en_de")
def transformer_nc11_en_de(args):
    transformer_iwslt_en_de(args)
