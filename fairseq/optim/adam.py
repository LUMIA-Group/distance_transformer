...
class FairseqAdamConfig(FairseqDataclass):
    ...
    gating_ratio: float = field(
        default=10.0, metadata={"help": "gate learning rate"}
    )
...
class FairseqAdam(FairseqOptimizer):
    ...
    def optimizer_config(self):
        ...
        return {
            ...
            "gating_ratio":self.cfg.gating_ratio
        }
...
class Adam(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        defaults = dict(
            lr=lr, betas=betas, eps=eps, weight_decay=weight_decay, amsgrad=amsgrad,gating_ratio=gating_ratio
        )
        ...
        for i,group in enumerate(self.param_groups):
            for p in group["params"]:
                ...
                if i==0:
                    ...
                    step_size = group["lr"]*group["gating_ratio"] * math.sqrt(bias_correction2) / bias_correction1
