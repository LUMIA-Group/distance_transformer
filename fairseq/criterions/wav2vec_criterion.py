...
class Wav2vecCriterion(FairseqCriterion):
    ...
    def reduce_metrics(logging_outputs) -> None:
        ...
        metrics.log_scalar("code_perplexity", float(logging_outputs[0]["code_perplexity"]))
        metrics.log_scalar("num_vars", float(logging_outputs[0]["num_vars"]))
        metrics.log_scalar("codebook_percentage",
                           float(logging_outputs[0]["code_perplexity"] / logging_outputs[0]["num_vars"]))
