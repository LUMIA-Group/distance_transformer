...
class CtcCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        # for mm2vec
        # net_output = model(sample["net_input"]['audio_source'],sample["net_input"]['visual_source'],sample["net_input"]['padding_mask'])
        ...
        # self.task.target_dictionary.string(targets_flat)
