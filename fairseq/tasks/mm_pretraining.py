...
from .. import utils
from ..data.raw_mm_dataset import FileMMDataset
...
@dataclass
class MMPretrainingConfig(FairseqDataclass):
    ...
    # inferred_w2v_config: Optional[InferredM2VConfig] = field(
    #     default=None,
    #     metadata={
...
@register_task("mm_pretraining", dataclass=MMPretrainingConfig)
class MMPretrainingTask(FairseqTask):
    """ """

    cfg: MMPretrainingConfig
    ...
    @classmethod
    def setup_task(cls, cfg: MMPretrainingConfig, **kwargs):
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            ...
            self.datasets[split] = FileMMDataset(
        ...
        if task_cfg.labels:
            ...
            # self.target_dictionary.string(self.datasets[split][i]['label'].tolist())
    ...
    def build_model(self, model_cfg: FairseqDataclass):
        ...
        if actualized_cfg is not None:
            if "m2v_args" in actualized_cfg:
                model_cfg.m2v_args = actualized_cfg.m2v_args
